...
SELECT account_id, primary_poc, sales_rep_id
FROM accounts
...
FROM orders
WHERE gloss_qty BETWEEN 24 AND 29; -- includes 24 and 29
...
/* Write a query that returns a list of orders where the standard_qty is
 ...
 WHERE (name LIKE 'C%' OR 'W%')
          ...
          AND primary_poc NOT IN '%eana');


/* SUMMARY

STATEMENT   HOW TO USE IT                 OTHER INFO
